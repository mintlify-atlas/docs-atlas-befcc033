...
<Tabs>
  <Tab title="Telegram">
    ...
    This toggles routing on or off. When on, replies include a small indicator showing the model used: `⚡ auto · claude-sonnet-4.6`.
  </Tab>
  <Tab title="TUI">
    ```
    /model
    ...
    View the current model. Routing state is reflected in the status line.
  </Tab>
